...
int main(int argc, char *argv[])
{
	...
	adios2::Variable<int8_t> varV1 =
            io.DefineVariable<int8_t>("v1", {}, {}, {Nglobal});

	       adios2::Attribute<int> attribute =
            io.DefineAttribute<int>("attrINT", -1);
	    ...
	    for (size_t i = 0; i < Nglobal; i++)
                ...
                writer.Put<int8_t>(varV1, v1.data(), adios2::Mode::Sync);
            writer.EndStep();
